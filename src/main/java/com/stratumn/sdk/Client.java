...
public class Client {
   ...
   private synchronized void login() throws TraceSdkException {
      ...
      } else if (Secret.isPrivateKeySecret(options.getSecret())) {
      ...
      } else if (Secret.isProtectedKeySecret(options.getSecret())) {
   ...
   /**
    * Executes the query and return a responseEntity of type passed
    * 
    * @param url
    * @param auth
    * @param query
   ...
   /***
    * Expects a list of fileWrappers, uploads the files encrypted and return
    * response
    * 
    * @param filesList
    * @return
